export default function Home() {
  ...
  return (
    <main className="bg-slate-50 text-slate-800">
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-slate-100 shadow-sm">
        <div className=" mx-auto flex items-center justify-between px-6 py-4">
          ...
          <nav className="hidden md:flex items-center gap-1">
            <a
              href="#"
              className="px-4 py-2 rounded-lg bg-blue-600 text-white text-sm font-semibold shadow"
            >
              Home
            </a>
            <a
              href="#"
              className="px-4 py-2 rounded-lg text-slate-500 hover:bg-slate-100 hover:text-slate-800 text-sm font-medium transition-colors"
            >
              Results
            </a>
            <a
      ...
      {/* ================= HERO ================= */}
      <section className="text-center px-6 py-20 md:py-28  mx-auto">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold leading-tight tracking-tight mb-6 text-slate-900">
          <div>Your Gateway to{" "}<span className="bg-gradient-to-r from-blue-600 to-blue-400 bg-clip-text text-transparent">Academic</span></div> <span className="bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent">Success</span>
        </h1>
        ...
        <p className="text-slate-500 text-sm sm:text-base max-w-lg mx-auto mb-10 leading-relaxed">
          ...
          comprehensive study notes all in one place. Learning made simple and
          effective.
        </p>
